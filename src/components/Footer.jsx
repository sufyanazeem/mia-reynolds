...
const Footer = () => {
  return (
    <footer className='bg-prime section h-[500px] xl:h-auto'>
      ...
      {/* email link */}
        ...
        >
          <Link href='mailto:hello@iareynolds.com'>
            <h2 className='text-[24px] lg:text-[38px] font-semibold leading tight'>hello@iareynolds.com</h2>
          </Link>
        </motion.div>
...
/>
      ...
      <motion.div
       variants={fadeIn("up", 0.4)}
        ...
        viewport={{ once: false, amount: 0.3 }}
      >
      <Social containerStyles='flex text-[24px] gap-x-8'
      ...
      >
      <Link href={'#'} className='relative flex w-[250px] h-[50px] transition-all'>
          <Image 
